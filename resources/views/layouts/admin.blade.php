...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        />
        <script
            src="https://kit.fontawesome.com/9b4e0d0281.js"
