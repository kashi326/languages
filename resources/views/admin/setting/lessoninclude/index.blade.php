    ...
    <div class="card my-5" id="main-card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="#addInclude" data-toggle="modal" data-target="#addInclude" class="btn btn-primary d-flex align-items-center justify-content-between"><span> Add</span> &nbsp;<img src="{{asset('icons/plus.svg')}}" width="20" height="20"></a>
            </div>
            <hr />
            @if(!$includes->isEmpty())
