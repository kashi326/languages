...
<div class="container">
    <div class="card my-5">
        <div class="list-group list-group-horizontal" id="myList" role="tablist">
            <a class="list-group-item list-group-item-action" data-toggle="list" href="#personal_details" role="tab">Personal Details</a>
            <a class="list-group-item list-group-item-action active" data-toggle="list" href="#lang_details" role="tab">Language Details</a>
            <a class="list-group-item list-group-item-action" data-toggle="list" href="#timing_details" role="tab">Timing Details</a>
        </div>
            ...
            <div class="tab-content">
                <div class="card-body tab-pane" id="personal_details" role="tabpanel">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="tutor name" value="{{$teacher->name}}" name="name">
                            @error('name')
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="tutor lastname" value="{{$teacher->lastname}}" name="lastname">
                            @error('lastname')
                            <div class="invalid-feedback d-block">
                                <strong>{{$message}}</strong>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="gender" id="gender" class="form-control">
                                ...
                                <option value="others" @if($teacher->gender == 'other') selected @endif>Others</option>
                            </select>
                            @error('gender')
                            <div class="invalid-feedback d-block">
                                <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="enter phone" value="{{$teacher->user->email}}" disabled>

                        </div>
                        <div class="col-md-6 form-group">
                            <label for="phone">Phone</label>
                            <input type="tel" name="phone" class="form-control" value="{{$teacher->phone}}" placeholder="teacher phone number">
                            @error('phone')
                            <div class="invalid-feedback d-block">
                                <strong>{{$message}}</strong>
                            </div>
                ...
                <input type="text" hidden name="teacher_id" value="{{$teacher->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="language_id" id="language_id" placeholder="Select language" class="chosen form-control" >
                        @foreach($languages as $language)
                    ...
                    <div class="form-group row" v-for="lang in other_langs">
                        <div class="col-md-5 px-0">
                            ...
                            <select name="other_language[]" id="other_language" placeholder="Select language" class="chosen form-control">
                                @include('includes.languages')
                            </select>
                        </div>
                        <div class="col-md-5">
                            <label for="level"><strong>Level</strong></label>
                            <select name="level[]" id="level" class="chosen form-control" placeholder="set experience level">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="time" id="open" name="open[]" class="form-control" value="{{$time->open}}">
                                    </div>
                                </td>
                                <td>
                                    <div class="input-group">
                                        <input type="time" id="close" name="close[]" class="form-control" value="{{$time->close}}">
                                    </div>
                                </td>
                            </tr>
                            @endforeach
