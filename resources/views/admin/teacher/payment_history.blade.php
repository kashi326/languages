...
@section('content')
    <div class="container">
        <div class="card my-5" style="box-shadow: none !important;" id="main-card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h3>Teacher Payments History</h3>
                </div>
        ...
        <div class="my-2">
            <p>Apply filter to view payment history</p>
            <form action="" method="get" class="d-flex align-items-end">
                <div class="form-group">
                    <label for="from">From</label>
                    <input class="form-control" type="date" name="from" id="from" value="{{$_GET['from']??""}}">
                </div>
                <div class="form-group mx-2">
                    <label for="to">To</label>
                    <input class="form-control" type="date" name="to" id="to" value="{{$_GET['to']??""}}">
                </div>
                <div class="form-group">
        ...
        @foreach($formatted_payments as $key => $mon_payment)
            <div class="card my-5" style="box-shadow: none !important;">
                <div class="card-body">
        ...
        @endforeach
        @if(count($formatted_payments)==0)
            <div style="box-shadow: none !important;" class="card p-2 d-flex justify-content-center">

                <div class="empty-state">
                    <div class="empty-state__content">
                        <div class="empty-state__icon d-flex justify-content-center">
                            <img
                        ...
                        <div class="empty-state__message text-center    ">No records has been found.</div>
                        <div class="empty-state__help text-center   ">
                            Change filter to see records.
                        </div>
                    </div>
                </div>
            </div>
