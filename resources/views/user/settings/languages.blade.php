...
<div class="card mb-2 lesson-card">
    <div class="card-body">
        <div class="row">
            <div class="col-6 pt-0 d-flex align-items-center">
                <img src="{{$lang->avatar?:'icons/translate.png'}}" width="50" height="50" class="rounded-circle">
...
<div class="empty-state">
    <div class="empty-state__content">
        ...
        <div class="empty-state__message">No records has been found.</div>
        <div class="empty-state__help">
            No Learning languages added. <a href="{{route('dashboard')}}">Add Language</a>
        </div>
    </div>
</div>
@endif
