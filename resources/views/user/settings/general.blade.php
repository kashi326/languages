        ...
        <div class="col-12 col-md-4 col-lg-3">
            <div class="card">
                <ul class="list-group side-links">
                    ...
                    <li class="list-group-item"><a class="text-decoration-none profile-link" href="{{route('setting.profile.picture.get')}}" data-remote="true" data-method="get"> <img src="{{asset('icons/camera.svg')}}" alt="" width="25" height="25"> Profile Photo</a>
                    </li>
                    <li class="list-group-item"><a class="text-decoration-none profile-link" href="{{route('setting.language.get')}}" data-remote="true" data-method="get"> <img src="{{asset('icons/tlanguage.svg')}}" alt="" width="25" height="25"> Languages</a>
                    </li>
                    ...
                    {{-- Notifications</a></li>--}}
                    <li class="list-group-item"><a class="text-decoration-none profile-link" href="{{route('setting.payments.get')}}" data-remote="true" data-method="get"> <img src="{{asset('icons/card_in_use.svg')}}" alt="" width="25" height="25">
                            Payments</a></li>
                    @if(Auth::user()->role != 'admin')
                    <li class="list-group-item"><a class="text-decoration-none profile-link" href="{{route('setting.user.get')}}" data-remote="true" data-method="get"> <img src="{{asset('icons/minus.svg')}}" alt="" width="25" height="25">
                            Deactivate</a></li>
                    @endif
                </ul>
            </div>
