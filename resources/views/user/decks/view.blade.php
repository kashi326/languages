...
<div class="container">
    <div class="row">
        ...
        <h4 class="text-main"><b>{{$deck->name}} <a href="{{route('view.teacher',[$deck->teacher->id,$deck->teacher->name])}}" class="text-main text-decoration-none font-2">Book Lesson</a></b></h4>
            <p class="text-left">
                {{$deck->description}}
            </p>
