...
<header>
    <div class="content  m-auto">
        ...
        <h5 style="color: black">
            ...
            Languages gift card to someone today, redeemable for purchasing lessons w
            ith any teacher.
        </h5>
...
<div class="row" style="padding: 0 0 20px 0; background-color:white;height:400px;">
    <div class="zoom col-md-4">
        <h4 class="text-bold">How Languages Gift Cards Work</h4>
...
<div class="row" style="padding: 0 70px 30px 70px; background-color:white">
    ...
    <div class="zoom col-md-4">
        ...
        <div>
            ...
            <p class="text-large"><span>Choose the amount you would like to give. Languages offers gift cards in the
...
<div class="container1">
    ...
    <div class="accordion">
        <div class="accordion-item">
            ...
            <div class="content">
                <p>Yes! Gift cards are redeemable with any teacher on Languages..</p>
            </div>
        </div>
        <div class="accordion-item">
            <a>Can I use gift cards for any language?</a>
            <div class="content">
                <p>Of course. Gift cards may be used with any teacher of any language on Languages.</p>
            </div>
        </div>
        <div class="accordion-item">
...
<div class="react-reveal" style="animation-fill-mode: both; animation-duration: 1000ms; animation-delay: 0ms; animation-iteration-count: 1; opacity: 1; animation-name: react-reveal-111008823989963-1;">
    <div class="LandingPage__Waves flex flex-direction-column flex-justify-content-center text-center" style="background-image:linear-gradient(116deg, #0699cd, #3bb85c)">
        <div style="padding: 100px 0 0 0">
            ...
            <a href="/buy" style="font-size: 220%; background-color:white;color:blue" class="btn btn-primary btn-lg">Buy a Gift Card</a>
        </div>
        <div class="LandingPage__Waves__bottom"><img src="https://cdn.Languages.com/static/svg/482d12a014dd62db2c8cc624a86b3850.waves-bottom.svg" alt="blue background"></div>
    </div>
</div>
<script>
