                    ...
                    <div class="card mb-2">
                        ...
                        <div class="card-body">
                            @foreach($fav_teacher as $fteacher)
                                <a href="{{route('view.teacher',[$fteacher->teacher_id,$fteacher->teacher_name])}}"><img
                                        src="{{ $fteacher->avatar?asset($fteacher->avatar):asset('images/avatar.png') }}"
                                        width="60" height="60" class="rounded-circle" alt="{{$fteacher->teacher_name}}"></a>
                            @endforeach
                        </div>
                    ...
                    <div class="col-6 d-flex justify-content-end">
                        <div class="btn-group" data-toggle="buttons">
                            <label class="btn btn-outline-primary form-check-label h-75">
                                <input class="form-check-input h-50" type="radio" name="list_calendar" id="list"
                                       autocomplete="off" checked value="list">
                                List
                            </label>
                            <label class="btn btn-outline-primary form-check-label h-75">
                                <input class="form-check-input h-50" type="radio" name="list_calendar" id="calendar"
                                       autocomplete="off" value="calendar"> Calendar
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="row" id="{{$lang->id}}">
                                    <div class="col-6 pt-0 d-flex">
                                        <img alt="" src="{{asset($lang->avatar)}}" width="50" height="50"
                                             class="rounded-circle">
                                        <p class="ml-2">{{$lang->name}}</p>
                                    </div>
                                    <div class="col-6 d-flex">
                                        <a href="{{route('language.speaks.delete',$lang->speakID)}}" data-remote="true"
                                           data-method="get" class="btn btn-outline-danger btn-sm ml-auto h-75 delete"
                                           data-confirm="Are You sure you want to remove this language?">Remove</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 pt-0 pb-0 mb-1">
                                        <input type="checkbox" name="currentlylearning"
                                               id="currentlylearning" {{ $lang->currently_learning?'checked':'' }}>
                    ...
                    @endphp
                    <form action="{{route('setting.language.speak.add')}}" method="post" id="NewLanguage"
                          data-remote="true">
                        <div class="row">
                            <div class="col-sm-4 form-group">
                                <select name="UserSpeak" id="UserSpeak"
