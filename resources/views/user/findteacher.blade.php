...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-horizontal">
                    ...
                    <div class="card-body p-2">
                        <div>
                            ...
                            @endif
                            <a href="{{route('view.teacher',[$teacher->teacherid,$teacher->teachername])}}" class="btn btn-primary rounded-button float-right d-none d-md-block">View Profile</a>
                        </div>
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <div class="ml-sm-2">
                                <strong> From:</strong>
                                <h5 class="mt-1">{{$teacher->country}}</h5>
                            </div>
                            <div class="ml-sm-2">
                                <strong>Total Lessons:</strong>
                                <h5 class="mt-1">{{$teacher->lessons_count}}</h5>
                            </div>
                        </div>
        ...
        <div class="col-md-4 m-auto intro_card mt-3 d-none">
            ...
            <div class="card d-flex">
                <div class="card-body">
                    <iframe src="{{$teacher->intro}}" class="mx-auto w-100" height="250" frameborder="0" uk-video="autoplay:false"></iframe>
                    <a href="{{route('view.teacher',[$teacher->teacherid,$teacher->teachername])}}" class=" mt-1 btn btn-primary d-block">Book Lesson</a>
                </div>
            </div>
            @endif
        </div>
    ...
    <div class="empty-state">
        <div class="empty-state__content">
            ...
            <div class="empty-state__message">No Teacher has been found.</div>
            <div class="empty-state__help">
                Tweak Your filters and try again.
            </div>
        </div>
    </div>
    @endif
