                        ...
                        <div class="card">
                            <div class="card-horizontal">
                                <div class="img-square-wrapper p-2">
                                    <div class=""
                                         style="background-image: url('{{$teacher->avatar?asset($teacher->avatar):asset(`images/default.png`)}}');width: 150px;height: 150px;background-size: cover;border-radius: 50%"></div>
                                </div>
                                <div class="card-body p-2">
                                    <div class="mb-4">
                                        ...
                                        <a href="{{route('view.teacher',[$teacher->teacherid,$teacher->teachername])}}"
                                           class="text-decoration-none rounded-button float-right d-none d-md-block">View
                                            Profile</a>
                                    </div>
                    ...
                    <div class="col-md-4 m-auto intro_card mt-3 d-none">
                        @if($teacher->intro)
                            <div class="card d-flex">
                                <div class="card-body">
                                    <iframe src="{{$teacher->intro}}" class="mx-auto w-100" height="250"
                                            frameborder="0" uk-video="autoplay:false"></iframe>
                                    <a href="{{route('view.teacher',[$teacher->teacherid,$teacher->teachername])}}"
