        ...
        <div class=" ml-auto mr-auto col-12 col-md-10 col-lg-8">
            <div class="card">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 pl-5">
                            <p class="font-2">
                                Lesson Start at: <strong class="text-main">{{ $lesson->timing->open }}</strong>
                            </p>
                            <p class="font-2">
                                Lesson Ends at: <strong class="text-main">{{ $lesson->timing->close }}</strong>
                            </p>
                            <p class="font-2">
                                Date:
                        ...
                        <div class="col-12 col-md-12">
                            ...
                            @else
                                <div class="row justify-content-content">
                                    <img src="{{asset('/icons/collaborationfemalemale.svg')}}" width="50" height="50"
                                         alt="img" style="margin-left:45%"/>
                                ...
                                <div>
                                    @if ($lesson->homework->isExpired == null || $lesson->homework->isExpired > date('Y-m-d H:i:s'))
                                        ...
                                        <form action="" id="homeworkResponse" enctype="multipart/form-data">
                                            <input type="text" name="homeworkID" value="{{ $lesson->homework->id }}"
                                                   hidden/>
                                            <div class="form-group row">
                                                <label for="fileUpload"
                                                       class="file-upload btn btn-primary btn-block btn-sm rounded-pill shadow"><i
                                                        class="fa fa-upload mr-2"></i>Browse for
                                                    file ...
                                                    <input id="fileUpload" name="responseFile" type="file"
                            ...
                            <div class="col-12 col-md-10 m-auto">
                                <form id="feedbackForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="feedback" id="feedback" class="form-control" cols="30"
                                                  rows="4">{{ $lesson->feedback }}</textarea>
                                        <div id="feedbackError" class="mt-1"></div>
                                    </div>
                                    <div class="form-group">
                                        <a class="btn btn-primary btn-sm float-right text-decoration-none text-light"
                                           id="submitFeedback">Submit</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    ...
                    @if(!$lesson->isAttended)
                        <a href="{{ route('lesson.reschedule',$lesson->id) }}"
                           class="btn btn-success btn-sm">Reschedule</a>
                    @endif
                </div>
            </div>
        </div>
