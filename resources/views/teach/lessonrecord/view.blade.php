            ...
            <div class="card">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-8">
                            <p>Name:
                                <strong>{{$lesson->teacher->user->name}}{{ $lesson->teacher->user->lastname}}</strong>
                            </p>
                            <p>mail: <a
                                    href="mailto:{{$lesson->teacher->user->email}}">{{$lesson->teacher->user->email}}</a>
                            </p>
                        </div>
                    </div>
                    <hr>
                            ...
                            <div class="w-75 m-auto">
                                @if(!$lesson->isAttended && Carbon::now()->tz(auth()->user()->timezone)->diffInMinutes($lesson->scheduled_date,false)<=(900))
                                    <div class="d-flex flex-column justify-content-center">
                                        <a href="{{route('teacher.meeting',[$lesson->id,$lesson->teacher->user_id])}}"
                                           target="_blank" class="btn btn-primary">Start Meeting</a>
                                ...
                                <form id="platformForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="platformName" id="platformName"
                                               placeholder="Google Meet, Teams, Zoom ..." value="{{$lesson->platform}}"
                                               disabled>
                                        <div id="platformNameError" class="mt-1"></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Lesson Link</label>
                                        <input type="text" class="form-control " name="lessonLink" id="lessonLink"
                                               placeholder="Link to class" value="{{$lesson->link}}" disabled>
                                ...
                                <form action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="fileUpload"
                                            ...
                                            <input id="fileUpload" name="homeworkFile" style="opacity:0" type="file"
                    ...
                    @if ($lesson->homework && $lesson->homework->response_path != null)
                        <div class="mb-3 w-75 m-auto">
                            <span class="font-3">Homework Submitted by student</span>
