...
Route::middleware('timezone')->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Meeting
        Route::get('/meeting/{id}/{userid}', "MeetingController@index")->name("meeting.start");
        Route::get('/meeting/student/{id}/{userid}', "MeetingController@start")->name('meeting.student');
